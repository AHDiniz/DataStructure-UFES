...
* output: um inteiro de comportamento booleano que diz se a pilha está vazia ou não
* pre-condicao: pilha não vazia
...
/*Tamanho da pilha
* inputs: ponteiro para a pilha 
* outputs: tamanho da pilha
* pré-condições: pilha não vazia
